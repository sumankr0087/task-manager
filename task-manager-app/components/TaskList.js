                    ...
                    <div key={task.id} className='bg-white shadow-lg rounded-lg p-4 border'>
                        <div className="flex justify-between">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5">
                        ...
                        <p className="text-sm text-gray-700 mt-1">Status: {task.completed ? "Completed" : ""}</p>
